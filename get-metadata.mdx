---
title: "Metadata"
og:title: "Get YouTube, TikTok, Instagram, X (Twitter) or Facebook metadata | Supadata"
description: "Use this API endpoint to fetch metadata from videos and posts hosted on YouTube, TikTok, Instagram, X (Twitter) or Facebook. Supadata returns a unified schema with platform-specific fields."
icon: "circle-info"
---
