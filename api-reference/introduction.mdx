---
title: 'API Reference'
og:title: 'Supadata REST API Reference — Authentication, Endpoints & Rate Limits'
description: 'Complete Supadata REST API reference. YouTube transcripts, web scraping, metadata extraction. API key auth. Base URL: https://api.supadata.ai/v1'
---
...
<CardGroup cols={4}>
  ...
  <Card
    title="Metadata"
    icon="file"
    href="/api-reference/endpoint/metadata/metadata"
    color="FF713C"
  >
  ...
  <Card
    ...
    href="/api-reference/endpoint/extract/extract"
    color="FF713C"
  >
